        ...
        if (auto serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            ...
            if (auto editContext = serializeContext->GetEditContext())
            {
                editContext
                    ...
                    ->DataElement(AZ::Edit::UIHandlers::LineEdit, &ROS2SpawnPointComponentConfig::m_name, "Name", "Name")
                    ->DataElement(
                        AZ::Edit::UIHandlers::LineEdit, &ROS2SpawnPointComponentConfig::m_info, "Info", "Spawn point detailed description");
            }
        }
    }
