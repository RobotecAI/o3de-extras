...
namespace ROS2
{
        ...
        if (auto* serialize = azrtti_cast<AZ::SerializeContext*>(context))
        {
            ...
            if (auto* editContext = serialize->GetEditContext())
            {
                editContext->Class<ROS2GNSSSensorComponent>("ROS2 GNSS Sensor", "GNSS sensor component")
                    ...
                    ->DataElement(AZ::Edit::UIHandlers::Default, &ROS2GNSSSensorComponent::m_applyPostProcessing, "Apply Post Processing", "Apply post processing to the GNSS message")
                    ->Attribute(AZ::Edit::Attributes::ChangeNotify, &ROS2GNSSSensorComponent::OnPostProcessingChanged)
                    ->DataElement(AZ::Edit::UIHandlers::ComboBox, &ROS2GNSSSensorComponent::m_noiseType, "Noise Type", "The type of noise to apply")
    ...
    {
        m_gnssPostProcessing = AZStd::make_unique<GNSSPostProcessing>();
    ...
    AZ::Crc32 ROS2GNSSSensorComponent::OnPostProcessingChanged() const
    {
        ...
        return m_applyPostProcessing ? AZ::Edit::PropertyRefreshLevels::EntireTree : AZ::Edit::PropertyRefreshLevels::None;
    }
