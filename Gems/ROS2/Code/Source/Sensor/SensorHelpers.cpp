...
namespace ROS2
{
    ...
    {
        // In ROS2 gem we have at this moment two types of base classes for sensors, we need to check if the component is derived from one of them.
        // If we add more base classes for sensors in the future, we need to update this function.
