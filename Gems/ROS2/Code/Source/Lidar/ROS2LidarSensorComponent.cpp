    ...
    void ROS2LidarSensorComponent::FrequencyTick()
    {
        ...
        for (int i = 0; i < pointCount; ++i)
        {
            ...
            if (addIntensity)
            {
                ...
                memcpy(&message.data[i * message.point_step + nextFieldOffset], &intensity, sizeof(float));
